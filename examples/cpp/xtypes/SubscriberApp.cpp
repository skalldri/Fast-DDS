        ...
        DataReader* reader)
{
    ...
    {
        if (ALIVE_INSTANCE_STATE == info.instance_state && info.valid_data && TK_STRUCTURE == remote_type_object_.complete()._d())
        {
        ...
        bool& should_be_ignored)
{
        ...
        if (RETCODE_OK != DomainParticipantFactory::get_instance()->type_object_registry().get_type_object(
                ...
                remote_type_object_))
        {
            throw std::runtime_error("Cannot get discovered type from registry");
        }
...
void SubscriberApp::initialize_entities()
{
    ...
    DynamicTypeBuilder::_ref_type type_builder = DynamicTypeBuilderFactory::get_instance()->create_type_w_type_object(remote_type_object_);
