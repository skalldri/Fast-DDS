...
public:
    ...
    void init()
    {
        ...
        //Create reader
        reader_ = eprosima::fastdds::rtps::RTPSDomain::createRTPSReader(participant_, reader_attr_, history_,
                        &listener_);
...
private:
            ...
            const eprosima::fastdds::rtps::CacheChange_t* change)
    {
        ...
        if (receiving_)
        {
            ...
            eprosima::fastdds::rtps::ReaderHistory* history = reader->getHistory();
