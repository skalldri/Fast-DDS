...
protected:
    ...
    std::unordered_map < xtypes::TypeIdentfierWithSize,
            std::vector<std::pair<eprosima::ProxyPool<eprosima::fastdds::rtps::WriterProxyData>::smart_ptr,
    ...
    std::unordered_map < xtypes::TypeIdentfierWithSize,
            std::vector<std::pair<eprosima::ProxyPool<eprosima::fastdds::rtps::ReaderProxyData>::smart_ptr,
